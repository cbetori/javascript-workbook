...
const forEach = require("./higherOrder").forEach;
const map = require("./higherOrder").map;
const filter = require("./higherOrder").filter;
const some = require("./higherOrder").some;
const every = require("./higherOrder").every;
